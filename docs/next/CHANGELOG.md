...
### Fixed
- The WorkBuddy bridge now reports unanswered questions as blocked, including in resumed sessions outside the recent dashboard window, so tasks waiting for user interaction raise an attention notification instead of appearing to keep working.
